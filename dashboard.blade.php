    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mt-4">
            <div class="col-lg-7 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100"style="background-image: url('./img/image3.jpeg');
                background-size: cover;">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">Members Overviews</h6>
                    ...
                    <div class="card-body p-3">
                        ...
                        <a href="/list" class="btn btn-primary mt-3">Members</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
